...
export const SSR_ENTRY_PATH = path.resolve(SRC_DIR, CLIENT_ENVIRONMENT_NAME, `${SSR_ENTRY_NAME}.tsx`);
export const CLIENT_ENTRY_PATH = path.resolve(SRC_DIR, CLIENT_ENVIRONMENT_NAME, `${CLIENT_ENTRY_NAME}.tsx`);
